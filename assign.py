...
class StackOverFlowAnalysis():
    def __init__(self, input_file):
        ...
        self.data['continent']=self.data.apply(lambda x:pc.country_alpha2_to_continent_code(pc.country_name_to_country_alpha2(x['Country'].replace("Hong Kong (S.A.R)","Hong Kong"),cn_name_format="default")),axis=1)
